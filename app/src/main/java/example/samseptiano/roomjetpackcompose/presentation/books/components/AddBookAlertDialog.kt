...
import example.samseptiano.roomjetpackcompose.core.Constants.Companion.ADD_BUTTON
import example.samseptiano.roomjetpackcompose.core.Constants.Companion.ADD_BOOK
...
import example.samseptiano.roomjetpackcompose.core.Constants.Companion.DISMISS_BUTTON
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    onClick = {
                        closeDialog()
                        val book = Book(0, title, author, isFavorite)
                        addBook(book)
                    }
                ) {
                    Text(
